                    ...
                    <div
                        ...
                        <dl class="flex flex-wrap gap-4 mb-6">
                            ...
                            <div class="flex flex-none w-full gap-x-4">
                                ...
                                <dd class="text-sm leading-6 text-gray-300">{{ $listing->employment_type->getLabel() }}</dd>
                            </div>
                            ...
                            <div class="flex flex-none w-full gap-x-4">
                                ...
                                <dd class="text-sm leading-6 text-gray-300">
                                    <time
                                        datetime="{{ $listing->created_at->format('Y-m-d') }}">{{ $listing->created_at->format('F d, Y') }}</time>
                                </dd>
                            </div>
                        </dl>

                        <a
                            href="{{ $listing->apply_url }}" target="_blank"
